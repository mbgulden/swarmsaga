...
Isolates filesystem mutations inside ephemeral worktrees before atomic commit or rollback.
"""
...
class GitWorktreeManager:
    ...
    def create_worktree(self, tx_id: str, base_ref: str = "HEAD") -> Path:
        ...
        worktree_path = self.sagas_dir / tx_id
        ...
        if res.returncode != 0:
            ...
            # Fallback to local copy if not in a clean git repo
